...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        <div class="navbar-header">
            <div>
                <a class="navbar-brand" href="index.html" style="font-size: 32px;">机器人智能化作业信息管理系统云平台构建项目——后台登录界面</a>
            </div>
        </div>
    </div>
</nav>
...
<%--        <p>${requestScope.exception.message }</p>--%>
        ...
        <div class="form-group has-success has-feedback">
            <input type="text" name="loginAcct" value="hw" class="form-control" id="inputSuccess4"
